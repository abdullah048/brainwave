...
import { companyLogos, notificationImages } from '@/constants';
    ...
    <div className={`${className || ''}`}>
      ...
      <ul className='flex'>
        {companyLogos.map((logo, index) => (
          <li
            key={index}
            className='flex items-center justify-center flex-1 h-32'>
            <Image src={logo} alt='company-logo' width={134} height={134} />
          </li>
        ))}
      </ul>
    </div>
